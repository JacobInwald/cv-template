...
\begin{minipage}[t]{0.75\textwidth}
    \cvsect{Summary}
I am a Computer Science student at the University of Edinburgh, pursuing cyber security related fields. 
I have a strong background in programming, with a focus on Python and C, and I have experience in a variety of fields, from image manipulation to network security. 
My honours project - containerizing CVE exploit-code pairs to address the replication crisis in Cyber Security, has required me to hone skills with Docker, Makefile, Bash and C programming, alongside skilled use of Linux.
My courses at University have required me to interact with a breadth of knowledge, from PCAP analysis to melanoma recognition with deep learning, and my achievements at university demonstrate my success. 
...
While I have enjoyed my time at university, pushing the boundaries of my knowledge, \textit{applying} this knowledge to real-life high-stakes scenarios is something I believe I would excel in. 
\end{minipage}
