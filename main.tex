...
\begin{minipage}[t]{0.56\textwidth}
	...
	I have been programming since I was 7 years old, and pride myself on my ability to implement a wide range of programming ideas in various laguages. 
	I have always sought out problems to solve and I find that problem-solving is one of the most enoyable and interesting ways to apply myself. 
	I believe that the diversity of my project focuses shows this. 
	I excel in high-pressure and dynamic environments, as I have had to vie for excellence in many such environments - evidenced by my competition experience in climbing.\\
\end{minipage}
...
\begin{entrylist}
	...
	{HELIX Centre, Imperial College London, London W2}
	{
		...
		\newline
		\texttt{python} \slashsep \texttt{Databases}
	}
	\entry
        {2019}
		{Google Code In}
...
\begin{entrylist}
	...
	\entry
		...
		{The Shakespeare, Greene King Pubs, Edinburgh EH3}
		{
			...
			This role involved quick thinking, teamwork, and customer service, all in a high-pressure environment as it was during in the international Fringe festival.
			\newline
	...
	\entry
		...
		{Religion School, Belsize Square Synagogue, London NW3}
		{
			...
			This role involved leading discussions, managing classes of 9-12 children, maintaining their focus to ensure they were learning.
			\newline
			\texttt{Teaching}
		}
\end{entrylist}
...
\begin{entrylist}
	...
	\entry
		...
		{
			I assisted teaching climbing technique and safety to children from ages 9-15 every Saturday.
